              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="relative flex-1">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-2 text-sm font-semibold rounded-md shadow-sm border border-orange-300 bg-white text-orange-700 hover:bg-orange-100 transition-colors duration-200"
                  >
                    <span>
                      {phaseIcons[selectedPhase]} {selectedPhase}
                    </span>
                    <FaChevronDown
                      className={`transition-transform duration-200 ${
                        isPhaseDropdownOpen ? "transform rotate-180" : ""
                      }`}
                    />
                  </button>
                  {isPhaseDropdownOpen && (
                ...
                <div className="relative flex-1">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-2 text-sm font-semibold rounded-md shadow-sm border ${
                      !selectedPhase
                  ...
                  >
                    ...
                    <FaChevronDown
                      className={`transition-transform duration-200 ${
                        isFloorDropdownOpen ? "transform rotate-180" : ""
                      }`}
                    />
                  </button>
                  {isFloorDropdownOpen && selectedPhase && (
                    <div className="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-md border border-gray-200 max-h-60 overflow-auto">
                      {floorsArray.map((floor) => (
                        <button
                          key={floor}
      ...
      {showBookingForm && (
        ...
        >
          <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-lg overflow-hidden shadow-lg">
            {/* Left side - Image */}
            <div className="w-full md:w-1/2 h-[400px] md:h-[600px] animate-dropdown">
              <img
                src={houseInHands}
                alt="House in Hands"
                className="w-full h-full object-cover"
            ...
            {/* Right side - Form */}
            <div className="w-full md:w-1/2 bg-white p-6 animate-dropdown">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">
                Booking Details
              </h2>
              <form className="space-y-4">
