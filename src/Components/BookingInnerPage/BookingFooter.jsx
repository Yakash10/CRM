...
//         </div>
//         {/* Footer Section */}
//         <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-gray-700 pt-8">
//           <div>
...
//             <ul className="mt-2 space-y-2 text-gray-400">
//               <li className="flex gap-2"><img src={phone} alt="" /> +91 8056666902</li>
//               <li className="flex gap-2"><img src={email} alt="" />assetbuildventures@gmail.com</li>
//               <li className="flex gap-2"><img src={location} alt="" /> Ground floor, H-block, 5th street, Anna Nagar,
