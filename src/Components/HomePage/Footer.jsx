  ...
  return (
    <div className="bg-black text-white pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Contact Section */}
        <div
          className="relative bg-cover bg-center rounded-lg p-6 md:p-10 flex flex-col lg:flex-row justify-between items-center text-white bg-opacity-80"
          style={{
            backgroundImage: `url(${footerbackground})`,
          }}
        >
          <div className="max-w-md text-center lg:text-left mb-6 lg:mb-0">
            <h2 className="text-2xl md:text-3xl font-bold">LOOKING FOR MORE PROPERTIES?</h2>
          ...
          <div className="bg-white text-black p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form className="space-y-3">
              ...
              <input type="text" placeholder="Services" className="w-full p-2 border rounded" />
              <textarea placeholder="Write to us" className="w-full p-2 border rounded"></textarea>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 border-t border-gray-700 pt-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 mt-2">
              Welcome to Asset Build Ventures, a premier real estate and construction company based in Chennai, founded
              and led by Ganesh Veeramuthu.
            </p>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="mt-2 space-y-2 text-gray-400">
              ...
              <li className="flex items-center justify-center md:justify-start gap-2">
                ...
                Ground floor, H-block, 5th street, Anna Nagar, Chennai-600040, Tamil Nadu
              </li>
            </ul>
            <div className="mt-4">
