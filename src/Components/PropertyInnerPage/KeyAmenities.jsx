      ...
      <div className="mt-8">
        ...
        <div className="flex justify-between text-gray-700 text-sm mt-2">
          <div className="flex items-center">
            <span className="text-orange-500 mr-2">⬤</span> Principal & interest
          </div>
          <div className="flex items-center">
            <span className="text-yellow-500 mr-2">⬤</span> Property taxes
          </div>
          <div className="flex items-center">
            <span className="text-black mr-2">⬤</span> Homeowners insurance
          </div>
        </div>
      </div>

      {/* Loan Details */}
      <div className="mt-6 bg-gray-100 p-4 rounded-lg grid grid-cols-3 gap-4 w-full">
        <div>
          <p className="text-gray-600 text-sm">Down payment</p>
          <p className="font-semibold">20% (₹3,00,000) ✏️</p>
        </div>
        <div>
          <p className="text-gray-600 text-sm">Home price</p>
          <p className="font-semibold">₹2CR ✏️</p>
        </div>
        <div>
          <p className="text-gray-600 text-sm">Loan details</p>
          <p className="font-semibold">30-yr Nego. 6.67% ✏️</p>
        </div>
      </div>
    </div>
  );
